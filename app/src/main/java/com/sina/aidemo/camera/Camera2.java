...
//    private static final int MAX_PREVIEW_HEIGHT = 480;
    ...
    private CameraDevice.StateCallback mStateCallBack = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice camera) {
            Log.e(AIConstants.TAG, "Camera opened");
            stateCallbackOnOpened(camera);
        }

        @Override
        public void onDisconnected(@NonNull CameraDevice camera) {
            Log.e(AIConstants.TAG, "Camera closed");
    ...
    private void stateCallbackOnError(CameraDevice currentCameraDevice, int error) {
        ...
        currentCameraDevice.close();
        mCameraDevice = null;
        Log.e(AIConstants.TAG, "stateCallbackOnError: " + error);
    }
    ...
    private final TextureView.SurfaceTextureListener surfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            Log.e(AIConstants.TAG, "onSurfaceTextureAvailable");
